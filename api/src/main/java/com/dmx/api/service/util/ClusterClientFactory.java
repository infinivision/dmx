...
package com.dmx.api.service.util;

import com.dmx.api.service.yarn.JobParameter;
import com.dmx.api.service.yarn.YarnClusterConfiguration;
            ...
            try {
                ...
                if(dir.exists() && dir.isDirectory()) {
                    ...
                    if(mode.equals(ClusterMode.yarn.name())) {//on yarn cluster mode
                        ...
                        com.dmx.api.service.yarn.YarnClusterDescriptor clusterDescriptor = new com.dmx.api.service.yarn.YarnClusterDescriptor(
    ...
    private static YarnConfiguration loadYarnConfiguration(String yarnConfDir)
    {
        ...
        Stream.of("yarn-site.xml", "core-site.xml", "hdfs-site.xml").forEach(file -> {
            ...
            if (site.exists() && site.isFile()) {
                hadoopConf.addResource(new Path(site.toURI()));
            }
            else {
